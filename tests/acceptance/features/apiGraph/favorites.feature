Feature: favorites
  ...
  Scenario Outline: add a file to favorites in the personal space
    ...
    When user "Alice" marks file "parent/<file>" from space "Personal" as favorite using the Graph API
  ...
  Scenario: add a folder to favorites in the personal space
    ...
    When user "Alice" marks folder "parent" from space "Personal" as favorite using the Graph API
    Then the HTTP status code should be "201"
    And the JSON data of the response should match
      """
      {
  ...
  Scenario: add a shared file to favorites
    ...
    When user "Brian" marks file "textfile.txt" from space "Shares" as favorite using the Graph API
    Then the HTTP status code should be "201"
    And the JSON data of the response should match
      """
      {
  ...
  Scenario: add a shared folder to favorites
    ...
    When user "Brian" marks folder "parent/sub" from space "Shares" as favorite using the Graph API
    Then the HTTP status code should be "201"
    And the JSON data of the response should match
      """
      {
  ...
  Scenario: add a file of the project space to favorites
    ...
    When user "Brian" marks file "text.txt" from space "new-space" as favorite using the Graph API
    Then the HTTP status code should be "201"
    And the JSON data of the response should match
      """
      {
  ...
  Scenario: add a folder of the project space to favorites
    ...
    And user "Alice" has sent the following space share invitation:
      ...
      | shareType       | user         |
      | permissionsRole | Space Viewer |
    When user "Brian" marks folder "space-folder" from space "new-space" as favorite using the Graph API
    Then the HTTP status code should be "201"
    And the JSON data of the response should match
      """
      {
  ...
  Scenario: remove file from favorites from the personal space
    ...
    And user "Alice" has marked file "parent/textfile.txt" from space "Personal" as favorite
    When user "Alice" unmarks file "parent/textfile.txt" from space "Personal" as favorite
  ...
  Scenario: remove folder from favorites from the personal space
    Given user "Alice" has created folder "parent"
    And user "Alice" has marked folder "parent" from space "Personal" as favorite
    When user "Alice" unmarks folder "parent" from space "Personal" as favorite
    Then the HTTP status code should be "204"
  ...
  Scenario: remove file from favorites from the shares
    ...
    And user "Alice" has sent the following resource share invitation:
      ...
      | permissionsRole | Viewer     |
    And user "Brian" has a share "textfile.txt" synced
    And user "Brian" has marked file "textfile.txt" from space "Shares" as favorite
    When user "Brian" unmarks file "textfile.txt" from space "Shares" as favorite
    Then the HTTP status code should be "204"
  ...
  Scenario: remove folder from favorites from the shares
    ...
    And user "Alice" has sent the following resource share invitation:
      ...
      | permissionsRole | Viewer   |
    And user "Brian" has a share "parent" synced
    And user "Brian" has marked folder "parent/sub" from space "Shares" as favorite
    When user "Brian" unmarks folder "parent/sub" from space "Shares" as favorite
    Then the HTTP status code should be "204"
  ...
  Scenario: remove file from favorites from the project space
    ...
    And user "Alice" has sent the following space share invitation:
      ...
      | shareType       | user         |
      | permissionsRole | Space Viewer |
    And user "Brian" has marked file "text.txt" from space "new-space" as favorite
    When user "Brian" unmarks file "text.txt" from space "new-space" as favorite
    Then the HTTP status code should be "204"
  ...
  Scenario: remove folder from favorites from the project space
    ...
    And user "Alice" has sent the following space share invitation:
      ...
      | shareType       | user         |
      | permissionsRole | Space Viewer |
    And user "Brian" has marked folder "space-folder" from space "new-space" as favorite
    When user "Brian" unmarks folder "space-folder" from space "new-space" as favorite
    Then the HTTP status code should be "204"
